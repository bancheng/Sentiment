...
model.add(LSTM(256, input_shape=(100,128))) # try using a GRU instead, for fun
...
print("Train...")
model.fit(X_train[24000:], y_train[24000:], batch_size=batch_size, nb_epoch=1, validation_split=0.1, show_accuracy=True)
score = model.evaluate(X_test[24000:], y_test[24000:], batch_size=batch_size)
print('Test score:', score)

classes = model.predict_classes(X_test[24000:], batch_size=batch_size)
acc = np_utils.accuracy(classes, y_test[24000:])
print("shuchu", classes)
